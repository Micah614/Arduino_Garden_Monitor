...
<strong>Project Goal:</strong> Assemble an Arduino device to monitor the pH, TDS, temperature, humidity, etc. of my 4x4 indoor garden grow tent, and monitor live-stream data from these devices on my laptop computer or cell phone. 
