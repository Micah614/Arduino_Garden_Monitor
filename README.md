...
<strong>Vision Statement:</strong> My goals for this project are: 1.) Learn the basics of hardware monitoring and control, 2.) develop hands-on experience with IOT networks and application-driven devices 3.) gain practice with object oriented programming in C++ and server programming in Python, and 3.) Extend my knowledge of XML data formatting and web-development in HTML/CSS/JavaScript. 
