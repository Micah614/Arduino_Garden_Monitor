...
The objective of this project is to create an Arduino monitoring system for a 4X4 grow tent containing a mixture of potted plants and two mobile reservior hydroponic systems. I will construct a basic WiFi connected sensor that will collect pH, basin temperature, and soil moisture and deliver them to a web URL using REACT hooks. This instrument will be used to monitor my garden while my wife and I are away on vacation. 
